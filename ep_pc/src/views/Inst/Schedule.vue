<template>
    <div>
        ...
        <el-dialog title="考试" :visible.sync="testFormVisible">
            <el-form :model="testToAdd">
                <div style="padding-right:3rem">
                    <el-form-item label="标题" prop="title" label-width="120">
                        <el-input v-model="testToAdd.title" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="考试时长(分钟)" prop="totalTime" label-width="120">
                        <el-input v-model="testToAdd.totalTime" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="开始时间" prop="startTime" label-width="120">
                        <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" v-model="testToAdd.startTime" type="datetime"
                            placeholder="选择时间">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label="截至时间" prop="endTime" label-width="120">
                        <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" v-model="testToAdd.endTime" type="datetime"
                            placeholder="选择时间">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label="题目" prop="problemScores" label-width="120">
                        <el-table :data="quesBank" stripe style="width: 100%">
